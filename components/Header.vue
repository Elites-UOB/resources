    ...
    <div id="header" flex="~ col sm:row" gap-4 sm:items-center justify-between>
        ...
        <div flex="~" justify-between gap-2 sm:gap-8>
            <div flex gap-3>
                ...
                <UiButton v-if="authStore.isAdmin" :text="[resourcesStore.modals.add ? 'b' : 'pw']" :alt="resourcesStore.getEditResource ? 'تعديل مصدر' : 'إضافة مصدر'" @click="() => { resourcesStore.modals.add = !resourcesStore.modals.add, resourcesStore.editResource = null }" square>
